(() => {
  ...
  // 2. Article paragraphs - site-specific selectors
  var domain = window.location.hostname.replace(/^www\./,'');
  var bodySelectors = {
    'nytimes.com':     "[data-testid='article-body'],.StoryBodyCompanionColumn,[id='article-body']",
    'cn.nytimes.com':  "[data-testid='article-body'],[class*='article-body'],[class*='article-content']",
    ...
    'ft.com':          "[class*='article__content-body']",
    'bloomberg.com':   "[class*='body-content']",
    default:           "article,.article-body,.paywall,[class*='article-body'],[role='article'],main,.story-body,.story-content"
  };

  var sel = bodySelectors[domain] || bodySelectors.default;
